...
const NoComputer = ({width, height}) => {
    //adapted from https://medium.com/@twineworks/fun-with-html-canvas-build-the-matrix-c87c4bb12487
    ...
    return <div>
        <canvas id="nomatrix__canvas" width={width} height={height} />
    </div>;
};
